...
#https://github.com/MahummadAyaanTricksz/
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if fol == '1' or fol == '01':
				...
				os.system("xdg-open https://instagram.com/mahummad_ayaan_tricks")
				...
				os.system("xdg-open https://github.com/MahummadAyaanTricksz")
